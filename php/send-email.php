<?php
	// Your Email
	$recipient = "info@waleednabil.com"; // PLEASE SET YOUR EMAIL ADDRESS
	$recaptcha_secret_key = 'KTRGFCXOT3BXU13PWD9PO74O5H2HBOEN'; // PLEASE SET YOUR GOOGLE RECAPTCHA API KEY. If you are not using, please leave it blank.
